...
json.various_ids identity.id do |id|
  json.type { json.partial! 'iam/identities/enumeration', value: id.identifier_type }
...
if identity.corporate_body
  json.corporate_body { json.partial! 'iam/identities/corporate_body', identity: identity, corporate_body: identity.corporate_body }
end

if identity.physical_person
  json.natural_person { json.partial! 'iam/identities/natural_person', identity: identity, natural_person: identity.physical_person }
end
...
json.addresses identity.physical_address do |a|
  ...
  json.country { json.partial! 'iam/identities/enumeration', value: a.country }
  json.region a.region.first
  json.district { json.partial! 'iam/identities/enumeration', value: a.county }
  json.municipality { json.partial! 'iam/identities/enumeration', value: a.municipality }
        ...
        if a.delivery_address.recipient
          if a.delivery_address.recipient.organization_unit || a.delivery_address.recipient.corporate_body_name
            json.corporate_body do
              ...
              json.partial! 'iam/identities/corporate_body_name', corporate_body: a.delivery_address.recipient
            end
          end

          if a.delivery_address.recipient.person_name
            json.natural_person do
              json.partial! 'iam/identities/natural_person_name', natural_person: a.delivery_address.recipient.person_name
            end
          end
...
json.phones identity.telephone_address do |p|
  json.type { json.partial! 'iam/identities/enumeration', value: p.telephone_type }
